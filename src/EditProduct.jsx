...
const EditProduct = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://nec-server.vercel.app/apiproducts/${id}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`https://nec-server.vercel.app/apiproducts/${id}`, productData);
