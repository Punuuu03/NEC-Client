...
const AddSale = () => {
  ...
  useEffect(() => {
    axios.get('https://nec-server.vercel.app/shalacustomers')
      .then(response => {
    ...
    axios.get('https://nec-server.vercel.app/shalaproducts')
      .then(response => {
  ...
  const handleCustomerChange = async (event) => {
    ...
    setCustomerId(id);
    try {
      const response = await axios.get(`https://nec-server.vercel.app/shalacustomers/${id}`);
  ...
  const handleProductChange = async (index, event) => {
    ...
    try {
      const response = await axios.get(`https://nec-server.vercel.app/shalaproducts/${id}`);
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://nec-server.vercel.app/shalasales', {
