...
const PurchaseList = () => {
  ...
  const fetchPurchases = async () => {
    try {
      const response = await axios.get('https://nec-server.vercel.app/walashalapurchases');
  ...
  const fetchPurchaseById = async (id) => {
    try {
      const response = await axios.get(`https://nec-server.vercel.app/walashalapurchases/${id}`);
