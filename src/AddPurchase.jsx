...
const AddPurchase = () => {
  ...
  useEffect(() => {
    axios.get('https://nec-server.vercel.app/followsuppliers')
      .then(response => {
    ...
    axios.get('https://nec-server.vercel.app/followproducts')
      .then(response => {
  ...
  const handleSupplierChange = async (event) => {
    ...
    setSupplierId(id);
    try {
      const response = await axios.get(`https://nec-server.vercel.app/followsuppliers/${id}`);
  ...
  const handleProductChange = async (index, event) => {
    ...
    try {
      const response = await axios.get(`https://nec-server.vercel.app/followproducts/${id}`);
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://nec-server.vercel.app/followpurchases', {
